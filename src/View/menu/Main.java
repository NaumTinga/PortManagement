...
int x, y;
  ...
  private void initComponents() {
    ...
    btnOperacao.setBackground(new java.awt.Color(239, 238, 244));
    btnOperacao.setForeground(new java.awt.Color(128, 128, 131));
    btnOperacao.setText("Operacao");
    btnOperacao.setColorHover(new java.awt.Color(204, 204, 204));
    btnOperacao.setColorNormal(new java.awt.Color(239, 238, 244));
    btnOperacao.setColorPressed(new java.awt.Color(204, 204, 204));
    btnOperacao.setColorTextHover(new java.awt.Color(128, 128, 131));
    btnOperacao.setColorTextNormal(new java.awt.Color(128, 128, 131));
    btnOperacao.setColorTextPressed(new java.awt.Color(128, 128, 131));
    btnOperacao.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
    btnOperacao.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
    btnOperacao.setIconTextGap(25);
    ...
    btnFeedBack.setColorHover(new java.awt.Color(204, 204, 204));
    btnFeedBack.setColorNormal(new java.awt.Color(239, 238, 244));
    btnFeedBack.setColorPressed(new java.awt.Color(204, 204, 204));
    btnFeedBack.setColorTextHover(new java.awt.Color(128, 128, 131));
    btnFeedBack.setColorTextNormal(new java.awt.Color(128, 128, 131));
    btnFeedBack.setColorTextPressed(new java.awt.Color(128, 128, 131));
    btnFeedBack.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
    btnFeedBack.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
    btnFeedBack.setIconTextGap(19);
  ...
  private rsbuttom.RSButtonMetro btnFeedBack;
  private rsbuttom.RSButtonMetro btnHome;
  private rsbuttom.RSButtonMetro btnOperacao;
  private rsbuttom.RSButtonMetro btnUsuario;
